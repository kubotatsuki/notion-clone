  ...
  return (
    <>
      ...
      >
        <div
          role="button"
          className={cn("h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolutee top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition",
          isMobie && "opacity-100",
      ...
      >
        <nav className="bg-transparent px-3 py-2 w-full">
          {isCollapse && <MenuIcon role="button" className="h-6 w-6 text-muted-foreground" />}
        </nav>
      </div>
    </>
  )
